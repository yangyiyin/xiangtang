...
CREATE TABLE `shopy_nf_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
`uid` int(11)  NOT NULL,
`sum` FLOAT (7,2) DEFAULT '0',
`hold` FLOAT (7,2) DEFAULT '0',
  `deleted` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
alter table shopy_nf_order_pre add dealer_profit FLOAT (9,2) DEFAULT '0';
alter table shopy_nf_order add dealer_profit FLOAT (9,2) DEFAULT '0';
