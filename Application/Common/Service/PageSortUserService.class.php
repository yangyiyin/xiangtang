 ...
 * Time: 2018-01-02 09:29:45
 */
namespace Common\Service;
class PageSortUserService extends BaseService{
    public static $name = 'PageSortUser';
    ...
    public function get_by_uid_page_id($uid, $id, $sort_id=false) {
        $NfModel = D('Nf' . static::$name);
        $where = [];
        $where['page_id'] = ['EQ', $id];
        $where['uid'] = ['EQ', $uid];
