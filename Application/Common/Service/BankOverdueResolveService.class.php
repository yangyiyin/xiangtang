...
class BankOverdueResolveService extends BaseService{
    public static $name = 'BankOverdueResolve';
  ...
  public function get_by_month_year($year, $month, $all_name) {
    ...
    public function get_by_month_year_all_names($year, $month, $all_names, $extra = []) {
        $FinancialModel = D('Financial' . static::$name);
        $where = [];
        $where['year'] = ['EQ', $year];
        $where['month'] = ['EQ', $month];
