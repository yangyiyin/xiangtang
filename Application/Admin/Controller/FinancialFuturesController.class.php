 ...
 */
 ...
 class FinancialFuturesController extends FinancialBaseController  {
     protected function _initialize() {
         parent::_initialize();
           $this->type = \Common\Model\FinancialDepartmentModel::TYPE_FinancialFutures;
     }
     ...
     public function submit_monthly()
     {
                if (IS_POST) {
                     ...
                     $this->title = '期货营业部单位月填报('. date('Y-m') .'月)';
                     if ($this->is_history) {
                         $this->title = '期货营业部单位月填报[正在编辑历史数据]';
                     }
