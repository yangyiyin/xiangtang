...
class LaughSysTips extends BaseSapi{
    ...
    public function excute() {
        $infos = [];
        $infos[]= ['title'=>'店长小助手:选择活动类别进行活动页面制作!', 'link'=>''];
        $infos[]= ['title'=>'店长小助手:在模板库可以选择自己喜欢的模板进行添加!', 'link'=>''];
        $infos[]= ['title'=>'店长小助手:可以在个人中心点击头像设置个性化头像哦!', 'link'=>''];
        $infos[]= ['title'=>'店长小助手:长按模板图片可以删除哦!', 'link'=>''];
